export default  [
    {
        ...
        description : "Meu portfólio pessoal que eu fiz aplicando todos os meus conhecimentos dês de o designer feito...",
    ...
    {
        name : "Auto add cards",
        description : "Apenas um pequeno projeto que eu desenvolvi com o objetivo de automatizar essa tarefa extremamente...",
    ...
    {
        name : "Bio Links",
        description : "Pequeno projeto pessoal, eu decidi fazer essa bio de links por conta própria porque eu posso customizar...",
    ...
    },
    {
        ...
        description : "Desafio de prática do servidor Codelandia do discord, nesse desafio aprendi sobre css grid e mais um pouco...",
